...
const Welcome: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center bg-slate-800/80 backdrop-blur-sm p-10 rounded-2xl border-2 border-dashed border-slate-700">
